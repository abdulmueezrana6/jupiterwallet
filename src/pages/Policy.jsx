    ...
    <div className='max-w-6xl mx-auto p-6'>
      ...
      <div className='bg-[#0b1220] p-6 rounded-2xl shadow-xl mb-6'>
        ...
        <p className='text-gray-400 text-sm'>
          Please read this privacy policy carefully before using the service. Below are the main categories of information Jupiter Wallet collects, how we use it, and the security measures we employ.
        </p>
      </div>
      ...
      <div className='bg-[#0b1220] p-6 rounded-2xl shadow-xl'>
        ...
        <div className='divide-y divide-white/5'>
          ...
          <AccordionItem title='6. Read and understand'>
            It is important to read and understand the privacy policy before using any app or service. Be aware of the data being collected and how it is used. By using Jupiter Wallet, you acknowledge and accept the terms described in this policy.
          </AccordionItem>
        </div>
      </div>
